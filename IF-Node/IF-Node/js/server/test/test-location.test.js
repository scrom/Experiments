...
exports.locationToStringReturnsValidJSON = function (test) {
    ...
    var bookMission = new mission.Mission('vicsBook',"Vic has a parcel for you but she'd like something to read first.",'',null,'book', true ,5, {isDestroyed: false,isBroken: false},'Vic',{score: 50, delivers: parcel, successMessage: "Congratulations. Vic likes the book! Have 50 points."});
