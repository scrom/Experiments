...
exports.toStringReturnsValidJSON = function (test) {
    ...
    var expectedResult = '{"object":"location","name":"reception","description":"a reception area","dark":"false","exits":[],"inventory":[{"name":"vic","display-name":"Vic","description":"Vic the receptionist","detailed-description":"Well, receptionist is an understatement to be honest.<br> She looks out for everyone here. Be nice to her.","attributes":{"weight":100,"attackStrength":25,"gender":"female","type":"friendly","carryWeight":15,"health":215,"affinity":0,"canTravel":false},"missions":[{"name":"keyfob","description":"Vic has a key fob for you.","dialogue":"Good morning $player.<br>Welcome aboard! Here\'s your key fob, you\'ll need this to get in and out of most parts of the office.","parent":"null","object":"Vic","static":"true","condition":"5","destination":"Vic","reward":{"score":10, "delivers":{"name":"keyfob","description":"a key fob","detailed-description":"Carrying this ensures you have access to the office whenever you need.","attributes":{"weight":0.1,"carryWeight":0,"attackStrength":0,"type":"key","canCollect":true,"canOpen":false,"isEdible":false,"isBreakable":false,"unlocks":""}}, "successMessage":"Have 10 points."}}, {"name":"vicsbook","description":"Vic has a parcel for you but she\'d like something to read first.","dialogue":"","parent":"null","object":"book","static":"true","condition":"5","destination":"Vic","reward":{"score":50, "delivers":{"name":"parcel","description":"a parcel","detailed-description":"A Parcel with key attributes - odd.","attributes":{"weight":0.1,"carryWeight":0,"attackStrength":0,"type":"key","canCollect":true,"canOpen":false,"isEdible":false,"isBreakable":false,"unlocks":""}}, "successMessage":"Congratulations. Vic likes the book! Have 50 points."}}]}]}';
...
exports.toStringReturnsValidJSON.meta = { traits: ["Location Test", "JSON Trait"], description: "Test that a location object converts to valid JSON via toString." };