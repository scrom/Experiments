...
exports.locationToStringReturnsValidJSON = function (test) {
    ...
    var keyFob = new mission.Mission('keyFob', null,"Vic has a key fob for you.",["Good morning $player.<br>Welcome aboard! Here's your key fob, you'll need this to get in and out of most parts of the office."],null,'Vic', true ,null,{isBroken: false},'Vic',{score: 10, delivers: fob, successMessage: "Have 10 points."});
    ...
    var bookMission = new mission.Mission('vicsBook', null,"Vic has a parcel for you but she'd like something to read first.",'',null,'book', true ,null, {isDestroyed: false,isBroken: false},'Vic',{score: 50, delivers: parcel, successMessage: "Congratulations. Vic likes the book! Have 50 points."});
    receptionist.addMission(bookMission);

    var expectedResult = '{"object":"location","name":"reception","description":"a reception area","exits":[],"inventory":[{"object":"creature","name":"vic","displayname":"Vic","description":"Vic the receptionist","detailedDescription":"Well, receptionist is an understatement to be honest.<br> She looks out for everyone here. Be nice to her.","attributes":{"weight":100,"attackStrength":25,"gender":"female","type":"friendly","carryWeight":15,"health":215,"affinity":0,"canTravel":false},"synonyms":["receptionist","vic","heidi","her"],"missions":[{"object":"mission","name":"keyfob","displayName":"null","description":"Vic has a key fob for you.","dialogue":["Good morning $player.<br>Welcome aboard! Here's your key fob, you'll need this to get in and out of most parts of the office."],"missionObject":"Vic","static":"true","conditionAttributes":{"isBroken":"false"},"destination":"Vic","reward":{"score":10, "delivers":{"object":"artefact","name":"keyfob","description":"a key fob","detailedDescription":"Carrying this ensures you have access to the office whenever you need.","attributes":{"weight":0.1,"carryWeight":0,"attackStrength":0,"type":"key","canCollect":true,"canOpen":false,"isEdible":false,"isBreakable":false,"unlocks":""}}, "successMessage":"Have 10 points."}}, {"object":"mission","name":"vicsbook","displayName":"null","description":"Vic has a parcel for you but she'd like something to read first.","missionObject":"book","static":"true","conditionAttributes":{"isDestroyed":"false", "isBroken":"false"},"destination":"Vic","reward":{"score":50, "delivers":{"object":"artefact","name":"parcel","description":"a parcel","detailedDescription":"A Parcel with key attributes - odd.","attributes":{"weight":0.1,"carryWeight":0,"attackStrength":0,"type":"key","canCollect":true,"canOpen":false,"isEdible":false,"isBreakable":false,"unlocks":""}}, "successMessage":"Congratulations. Vic likes the book! Have 50 points."}}]}]}';
