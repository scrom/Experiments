...
test('can normally run through a required run exit', () => {
    ...
    //p0.reduceHitPoints(6);
    var expectedResult = "You run North...<br><br>Current location: Office front entrance<br>You're standing outside the front of the Porta Rossa offices. The sun is shining and the business park security and maintenance crews are all busy doing their regular rounds.<br>You can find your way into the office to the South whilst out here there are footpaths and car parks to both the East and West.<br><br>You can see an ice cream man.<br>There are exits to the South, East, and West.<br>"
