...
var missionController = require('../../server/js/missioncontroller.js');
var customAction = require('../../server/js/customaction.js');
...
exports.canCompleteKillSpyMission = function (test) {
    ...
    var expectedResult = "<br><br>Jordan (the spy) is dead! Let's hope that's the end of all our troubles.<br>";
    var actualResult = resultString
    //if (result) {actualResult = true;};
    console.log("Expected: "+expectedResult);
    console.log("Actual  : "+actualResult);
